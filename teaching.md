...
I have extensive experience teaching and mentoring students in mathematics and its intersection with machine learning, from undergraduate courses to professional development bootcamps.

<!-- BITS Pilani WILP -->
<div class="section-title">
  <h2 style="color: var(--accent-primary);">BITS Pilani Work Integrated Learning Programmes</h2>
</div>

<div class="role-tile">
  <div class="role-header">
    <h3 style="color: #fff;">Guest Faculty</h3>
    <span style="color: var(--accent-secondary); font-weight: 500;">2025 – Present</span>
  </div>
  <p>Designed and delivered bridging mathematics courses for cohorts of 30–150 working professionals transitioning into software, analytics, and engineering roles.</p>
...
<div class="role-tile">
  <div class="role-header">
    <h3 style="color: #fff;">Teaching Assistant</h3>
    <span style="color: var(--accent-secondary); font-weight: 500;">Sep 2024 – May 2025</span>
  </div>
...
<div class="role-tile">
  <div class="role-header">
    <h3 style="color: #fff;">Teaching Assistant</h3>
    <span style="color: var(--accent-secondary); font-weight: 500;">2020 – 2025</span>
  </div>
  <p>Supported undergraduate and postgraduate teaching across core and advanced mathematics. Conducted interactive tutorials and problem-solving sessions for classes of 50–90 students.</p>
  <h4 style="margin-top: 1rem; font-size: 0.95rem; color: var(--text-main);">Subjects Handled:</h4>
  <ul style="color: var(--text-muted); margin-bottom: 0; padding-left: 1.5rem;">
    <li>Probability and Statistics</li>
    <li>Mathematics 1 (Calculus)</li>
    <li>Mathematics 3 (Differential Equations)</li>
    <li>Discrete Mathematics</li>
    <li>Graphs and Networks</li>
    <li>Measure & Integration</li>
    <li>Introduction to Topology</li>
    <li>Introduction to Functional Analysis</li>
  </ul>
</div>
...
<!-- CourseLeap Education -->
<div class="section-title">
  <h2 style="color: var(--accent-primary);">CourseLeap Education</h2>
</div>
...
<!-- MTTS Programme -->
<div class="section-title">
  <h2 style="color: var(--accent-primary);">MTTS Programme</h2>
</div>

<div class="role-tile">
  <div class="role-header">
    <h3 style="color: #fff;">Mentor</h3>
